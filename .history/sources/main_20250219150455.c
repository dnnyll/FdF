...
/*   Updated: 2025/02/19 15:04:55 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	// 	exit (0);
	// }
	map->window->win_ptr = mlx_new_window(map->mlx_ptr, map->window->win_width, 
	...
	bresenham(map);
	ft_printf("0002\n");
	mlx_put_image_to_window(map->mlx_ptr, map->window->win_ptr, map->render->img_ptr, map->iso->x1 ,map->iso->);
	ft_printf("0003\n");
