...
/*   Updated: 2025/02/14 07:47:09 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	if (map->c_z_matrix)
	{
		while (row < map->y)
		{
			if (map->c_z_matrix[row])
			{
				...
				while (j < map->x)
				{
					if (map->c_z_matrix[row][j])
						free(map->c_z_matrix[row][j]);
					j++;
				}
				free(map->c_z_matrix[row]);
			}
	...
	if (map->c_colours_matrix)
	{
		while (row < map->y)
		{
			if (map->c_colours_matrix[row])
			{
				...
				while (j < map->x)
				{
					if (map->c_colours_matrix[row][j])
						free(map->c_colours_matrix[row][j]);
					j++;
				}
	...
	if (map->coordinates_grid)
	{
		while (row < map->y)
		{
			if (map->coordinates_grid[row])
			{
				...
				while (j < map->x)
				{
					if (map->coordinates_grid[row][j])
						free(map->coordinates_grid[row][j]);
					j++;
				}
